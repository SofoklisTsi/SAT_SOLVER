...
This module contains the CDCLLogger class, which is used to log the solving steps of the CDCL SAT solver.
"""
...
class CDCLLogger(BaseModel):
    ...
    """
    cdcl_steps: List[Dict[str, Any]] = Field(default_factory=list, title="List of steps logged during the solving process.")
    ...
    def log_graph(self, decision_level: int, implication_graph: Dict[int, Dict[str, Optional[int]]], decision_literal: Optional[int] = None, implied_literal : Optional[int] = None,  learned_clause: Optional[List[int]] = None, backtrack_level: Optional[int] = None, cut_method: str = "") -> None:
        """
