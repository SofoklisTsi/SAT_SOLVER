...
class TrueTWLSATProblem(SATProblem):
    ...
    Extended SATProblem class that incorporates the Two Watched Literals (TWL) technique.
        The difference between this class and the TWLSATProblem class is that the true TWL class only considers
    ...
    def __init__(self, sat_problem_instance):
        ...
        self.clauses_by_literal = self._build_clauses_by_literal(self.clauses)
    ...
    def _update_watched_literals(self,clause_index, assigned_literal):
        ...
        Returns: False if the clause is satisfied, True if it finds a new unassigned watched literal.
        """
